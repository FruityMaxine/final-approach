...
- [x] Tick2 v0.39 着陆履历+成就(history.js localStorage持久化评分历史/统计均分最佳奶油率/6类成就;showReport钩子+reload持久化+手机零横滚实测PASS) — 2026-06-06
- [x] Tick3 v0.40 幽灵轨迹对比(ghost.js 最佳轨迹localStorage持久化+drawWorld复用project叠加幽灵航迹/幽灵机+开关面板;存/覆盖/叠加/清除+手机零横滚实测PASS) — 2026-06-06
- [x] Tick4 v0.41 载重平衡W- [ ] Tick4 载重平衡 W&BB(wb.js 4站位装载→GW/CG%MAC加权臂+配平+包线绿红/payload计入AC.m联动性能/修mcdu:164死值CG读WB.cg;CG超限+MCDU同步+手机零横滚实测PASS) — 2026-06-06
- [x] Tick5 v0.42 SID/STAR程序进近(procedures.js 多机场STAR库程序点含alt/spd限制并入WPTS+MCDU FPLN/ND显示+清除还原;选择+并入+显示+手机零横滚实测PASS) — 2026-06-06 ★组19收官
